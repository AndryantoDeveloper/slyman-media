...
<div class="panel panel-default">
	...
	<div class="panel-body">
		 {!! Form::open(array('route' => 'users.store','method'=>'POST','class'=>'form-horizontal','id'=>'FormSubmit')) !!}
		   ...
		   <div class="form-group">
		      ...
		      <div class="col-sm-10">
		        <input type="password" name="password" id="password" class="form-control" value="{{ old('old_password') }}" required/>
		   ...
		   <div class="form-group">
		      ...
		      <div class="col-sm-10">
		         ...
		         <div class="checkbox checkbox-inline">
                    {{ Form::checkbox('roles[]', $r->id, false) }} {{ $r->name }}
                 </div>
                @endforeach
		        @if ($errors->has('roles'))
	            <span class="help-block">
