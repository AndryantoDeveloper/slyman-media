...
<div class="panel panel-default">
	...
	<div class="panel-body">
		{!! Form::model($data, ['method' => 'PATCH','class'=>'form form-horizontal','id'=>'FormSubmit','route' => ['devices.update', $data->id]]) !!}
		   ...
		   <div class="form-group">
		      ...
		      <div class="col-sm-10">
		           ...
		           <label class="checkbox-inline">
		           	  @php
	           			$selected = $data->conditions->pluck("id")->toArray();
	           			$status = in_array($c->id,$selected) ? "checked" : "";
		           	  @endphp
				      <input type="checkbox" name="conditions[]" value="{{ $c->id }}" {{ $status }}> {{ $c->name }}
				   </label>
				   @endforeach
		      </div>
		   </div>
